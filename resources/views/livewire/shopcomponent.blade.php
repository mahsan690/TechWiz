                        ...
                        <div class="breadcrumb-index">
                            ...
                            <ul class="breadcrumb-list">
                                <li class="breadcrumb-title">
                                    <a href="{{route("home.index")}}" title="Back to the home page">Home</a>
                                </li>
                                <li class="breadcrumb-title">
                                    ...
                                    <div class="collection-img-wrap">
                                        ...
                                        <div class="collection-info">
                                            <div class="collection-image">
                                                <img src="{{asset('assets/image/collection/collection-banner.jpg')}}" class="img-fluid" alt="collection-banner">
                                            </div>
                                        </div>
                                        <!-- collection info end -->
                                    </div>
                                        ...
                                        <div class="sidebar-banner banner-hover">
                                            <a href="collection.html" class="sidebar-img banner-img">
                                                <span class="sidebar-banner-image">
                                                    <img src="{{asset('assets/image/collection/side-image.jpg')}}" class="img-fluid" alt="side-image">
                                                </span>
