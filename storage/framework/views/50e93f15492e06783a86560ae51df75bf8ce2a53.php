...
<head>
        ...
        <!-- favicon -->
        <link rel="shortcut icon" type="image/favicon" href="<?php echo e(asset('assets/image/favicon/favicon.png')); ?>">
        <!-- bootstrap -->
        ...
        <!-- feather -->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/feather.css')); ?>">
        <!-- slick css -->
        ...
        <!-- other page css -->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/other-page.css')); ?>">
        <!-- custom css -->
                        ...
                        <div class="col">
                            <div class="header-main">
                                ...
                                <div class="header-element header-logo">
                                    <a href="<?php echo e(route("home.index")); ?>" class="theme-logo">
                                        <img src="<?php echo e(asset('assets/image/logo/logo.png')); ?>" class="img-fluid" alt="logo">
                                    </a>
                                </div>
                                <!-- header-logo end -->
                                ...
                                <div class="header-element megamenu-content">
                                    ...
                                    <div class="main-wrap collapse show" id="desk-main-collapse">
                                        <ul class="main-menu">
                                            <li class="menu-link">
                                                <a href="<?php echo e(route("home.index")); ?>" class="link-title active">
                                            ...
                                            <li class="menu-link">
                                                <a href="<?php echo e(route("about.index")); ?>" class="link-title">
                                            ...
                                            <li class="menu-link">
                                                <a href="<?php echo e(route("shop.index")); ?>" class="link-title">
                                                        ...
                                                        <li class="productmenu-li">
                                                            <div class="product-banner banner-hover">
                                                                <a href="collection.html" class="banner-img">
                                                                    <img class="img-fluid" src="<?php echo e(asset('assets/image/menu-banner/menubanner-3.jpg')); ?>" alt="menubanner-5">
                                                                </a>
                                                            </div>
                                                        </li>
                                                        <li class="productmenu-li">
                                                            <div class="product-banner banner-hover">
                                                                <a href="collection.html" class="banner-img">
                                                                    <img class="img-fluid" src="<?php echo e(asset('assets/image/menu-banner/menubanner-2.jpg')); ?>" alt="menubanner-5">
                                                                </a>
                                                            </div>
                                                        </li>
                                                    </ul>
                                            ...
                                            <li class="menu-link">
                                                <a href="<?php echo e(route("home.index")); ?>" class="link-title">
                                            ...
                                            <li class="menu-link">
                                                <a href="<?php echo e(route("contact.index")); ?>" class="link-title">
                                                    <span class="sp-link-title">Contact Us</span>
                                                </a>
                                                <a href="#desk-menumain-single" data-bs-toggle="collapse" class="link-title link-title-lg">
                                                    <span class="sp-link-title">Contact Us</span>
                                ...
                                <li class="ftlink-li payment-block text-left text-lg-left">
                                    <div class="pay-icon">
                                        ...
                                        <a href="javascript:void(0)" class="payment-icon">
                                            <img src="<?php echo e(asset('assets/image/payment-icon/visa.svg')); ?>" alt="pay-icon">
                                            <img src="<?php echo e(asset('assets/image/payment-icon/paypal.svg')); ?>" alt="pay-icon">
                                            <img src="<?php echo e(asset('assets/image/payment-icon/master.svg')); ?>" alt="pay-icon">
                                            <img src="<?php echo e(asset('assets/image/payment-icon/american.svg')); ?>" alt="pay-icon">
                                        </a>
                                    </div>
                                    <div class="app-icon">
                                        <h2 class="ft-title">Download app</h2>
                                        <a href="<?php echo e(route("home.index")); ?>" class="img-content">
                                            <img src="<?php echo e(asset('assets/image/payment-icon/app-icon1.png')); ?>" class="img-fluid" alt="app-icon1">
                                        </a>
                                        <a href="<?php echo e(route("home.index")); ?>" class="img-content">
                                            <img src="<?php echo e(asset('assets/image/payment-icon/app-icon2.png')); ?>" class="img-fluid" alt="app-icon2">
                                        </a>
                                    </div>
                                </li>
                            </ul>
        ...
        <footer class="footer-bottom-area">
            <div class="container">
                <ul class="footer-bottom">
                    <li class="ftlink-li">
                        <a href="<?php echo e(route("home.index")); ?>" class="theme-logo">
                            <img src="<?php echo e(asset('assets/image/logo/logo.png')); ?>" class="img-fluid" alt="freozy">
                        </a>
                    </li>
                    <li class="ftlink-li">
                        <div class="richtext">
                                            ...
                                            <ul class="container ul p-0">
                                                <li class="bannermenu-li banner-hover">
                                                    <a href="collection.html" class="collection-img banner-img">
                                                        <img src="<?php echo e(asset('assets/image/menu-banner/menubanner-1.jpg')); ?>" class="img-fluid" alt="menubanner-1">
                                                    </a>
                                                    <a href="collection.html" class="collection-title"><span>New product</span></a>
                                                </li>
                                                <li class="bannermenu-li banner-hover">
                                                    <a href="collection.html" class="collection-img banner-img">
                                                        <img src="<?php echo e(asset('assets/image/menu-banner/menubanner-2.jpg')); ?>" class="img-fluid" alt="menubanner-2">
                                                    </a>
                                                    <a href="collection.html" class="collection-title"><span>Feature product</span></a>
                                                </li>
                                                <li class="bannermenu-li banner-hover">
                                                    <a href="collection.html" class="collection-img banner-img">
                                                        <img src="<?php echo e(asset('assets/image/menu-banner/menubanner-3.jpg')); ?>" class="img-fluid" alt="menubanner-3">
                                                    </a>
                                        ...
                                        <div class="menu-dropdown product-menu collapse" id="resp-menumain-product">
                                            <ul class="container ul p-0">
                                                ...
                                                <li class="productmenu-li">
                                                    <div class="product-banner banner-hover">
                                                        <a href="collection.html" class="banner-img">
                                                            <img class="img-fluid" src="<?php echo e(asset('assets/image/menu-banner/menubanner-5.jpg')); ?>" alt="menubanner-5">
                                                        </a>
                                                    </div>
                                                </li>
                                                <li class="productmenu-li">
                                                    <div class="product-banner banner-hover">
                                                        <a href="collection.html" class="banner-img">
                                                            <img class="img-fluid" src="<?php echo e(asset('assets/image/menu-banner/menubanner-6.jpg')); ?>" alt="menubanner-5">
                                                        </a>
                                                    </div>
                                                </li>
                                            </ul>
                                            ...
                                            <ul class="container ul p-0">
                                                ...
                                                <li class="blogmenu-li">
                                                    <div class="blog-banner banner-hover">
                                                        <a href="collection.html" class="banner-img">
                                                            <img class="img-fluid" src="<?php echo e(asset('assets/image/menu-banner/blogbanner-1.jpg')); ?>" alt="blogbanner-1">
                                                        </a>
                                                    </div>
                                                </li>
                                                <li class="blogmenu-li">
                                                    <div class="blog-banner banner-hover">
                                                        <a href="collection.html" class="banner-img">
                                                            <img class="img-fluid" src="<?php echo e(asset('assets/image/menu-banner/blogbanner-2.jpg')); ?>" alt="blogbanner-2">
                                                        </a>
                                                    </div>
                                                </li>
                                            </ul>
            ...
            <ul class="shop-element-menu navigation-menu">
                <li class="side-wrap home-wrap">
                    <div class="home-wrapper">
                        <a href="<?php echo e(route("home.index")); ?>" class="home-modal">
                                    ...
                                    <div class="swiper gallery-top">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="javascript:void(0)"><img src="<?php echo e(asset('assets/image/product/p-1.jpg')); ?>" class="img-fluid" alt="p-1"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <ul class="cart-item d-block">
                <li class="cart-product">
                    <div class="cart-img">
                        ...
                        <a href="product.html" class="img-area">
                            <img src="<?php echo e(asset('assets/image/cart/cart-1.jpg')); ?>" class="img-fluid" alt="cart-1">
                        </a>
                        <!-- minicart-img end -->
                    </div>
                ...
                <li class="cart-product">
                    <div class="cart-img">
                        <!-- minicart-img start -->
                        <a href="product.html" class="img-area">
                            <img src="<?php echo e(asset('assets/image/cart/cart-2.jpg')); ?>" class="img-fluid" alt="cart-2">
                        </a>
                        <!-- minicart-img end -->
                    </div>
                    <div class="cart-content">
                ...
                <li class="cart-product">
                    <div class="cart-img">
                        <!-- minicart-img start -->
                        <a href="product.html" class="img-area">
                            <img src="<?php echo e(asset('assets/image/cart/cart-3.jpg')); ?>" class="img-fluid" alt="cart-3">
                        </a>
                        <!-- minicart-img end -->
                    </div>
                    <div class="cart-content">
                ...
                <li class="cart-product">
                    <div class="cart-img">
                        <!-- minicart-img start -->
                        <a href="product.html" class="img-area">
                            <img src="<?php echo e(asset('assets/image/cart/cart-4.jpg')); ?>" class="img-fluid" alt="cart-4">
                        </a>
                        <!-- minicart-img end -->
                    </div>
                    <div class="cart-content">
                ...
                <li class="cart-product">
                    <div class="cart-img">
                        <!-- minicart-img start -->
                        <a href="product.html" class="img-area">
                            <img src="<?php echo e(asset('assets/image/cart/cart-6.jpg')); ?>" class="img-fluid" alt="cart-6">
                        </a>
                        <!-- minicart-img end -->
                    </div>
                    <div class="cart-content">
                ...
                <li class="cart-product">
                    <div class="cart-img">
                        <!-- minicart-img start -->
                        <a href="product.html" class="img-area">
                            <img src="<?php echo e(asset('assets/image/cart/cart-7.jpg')); ?>" class="img-fluid" alt="cart-7">
                        </a>
                        <!-- minicart-img end -->
                    </div>
                    <div class="cart-content">
                ...
                <li class="cart-product">
                    <div class="cart-img">
                        <!-- minicart-img start -->
                        <a href="product.html" class="img-area">
                            <img src="<?php echo e(asset('assets/image/cart/cart-8.jpg')); ?>" class="img-fluid" alt="cart-8">
                        </a>
                        <!-- minicart-img end -->
                    </div>
                    <div class="cart-content">
                ...
                <li class="cart-product">
                    <div class="cart-img">
                        <!-- minicart-img start -->
                        <a href="product.html" class="img-area">
                            <img src="<?php echo e(asset('assets/image/cart/cart-9.jpg')); ?>" class="img-fluid" alt="cart-9">
                        </a>
                        <!-- minicart-img end -->
                    </div>
                    <div class="cart-content">
                ...
                <li class="cart-product">
                    <div class="cart-img">
                        <!-- minicart-img start -->
                        <a href="product.html" class="img-area">
                            <img src="<?php echo e(asset('assets/image/cart/cart-10.jpg')); ?>" class="img-fluid" alt="cart-10">
                        </a>
                        <!-- minicart-img end -->
                    </div>
                    <div class="cart-content">
...
</html><?php /**PATH C:\xampp\htdocs\TechWiz4\TechWiz\resources\views/layouts/app.blade.php ENDPATH**/ ?>